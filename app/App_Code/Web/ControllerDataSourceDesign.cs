...
namespace arhmexico.Web.Design
{
    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                var res = GetType().Assembly.GetManifestResourceStream(string.Format("arhmexico.Controllers.{0}.xml", DataController));
                if (res == null)
                	res = GetType().Assembly.GetManifestResourceStream(string.Format("arhmexico.{0}.xml", DataController));
                if (res != null)
