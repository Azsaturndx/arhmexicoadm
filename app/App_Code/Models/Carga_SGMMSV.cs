...
{
	public enum Carga_SGMMSVDataField
    {
    ...
    public partial class Carga_SGMMSVModel : BusinessRulesObjectModel
    {
        ...
        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        private int? _mensajeSistemaId;
        
        public Carga_SGMMSVModel()
        {
        }
        
        public Carga_SGMMSVModel(BusinessRules r) : 
                base(r)
        {
        }
        ...
        public int? MensajeSistemaId
        {
            get
            {
                return _mensajeSistemaId;
            }
            set
            {
                _mensajeSistemaId = value;
                UpdateFieldValue("MensajeSistemaId", value);
            }
        }
        
        public FieldValue this[Carga_SGMMSVDataField field]
        {
            get
            {
