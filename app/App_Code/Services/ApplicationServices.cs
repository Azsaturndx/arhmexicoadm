...
namespace arhmexico.Services
{
    ...
    public class ApplicationServicesBase
    {
        ...
        {
            arhmexico.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            if (AuthorizationIsSupported)
            {
                ...
                try
                {
                    ...
                    if (css == null)
                    	css = ConfigurationManager.ConnectionStrings["arhmexico"];
                ...
                if (Membership.GetUser("admin") == null)
                {
                    ...
                    admin = Membership.CreateUser("admin", "admin123%", "admin@arhmexico.com", "ASP.NET", "Code OnTime", true, out status);
                    user = Membership.CreateUser("user", "user123%", "user@arhmexico.com", "ASP.NET", "Code OnTime", true, out status);
    ...
    public class ApplicationSessionStateBase : SessionStateStoreProviderBase
    {
        ...
        public SqlText CreateSqlText(string sql)
        {
            ...
            cmd.Name = "arhmexico Session State Provider";
