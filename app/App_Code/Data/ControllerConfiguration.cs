...
namespace arhmexico.Data
{
	public class ControllerConfiguration
    {
        ...
        protected virtual void Initialize(XPathNavigator navigator)
        {
            ...
            {
                var t = ApplicationServices.StringToType("arhmexico.Rules.SharedBusinessRules");
                if (t != null)
        ...
        public virtual void Complete()
        {
            ...
            if (string.IsNullOrEmpty(_connectionStringName))
            	_connectionStringName = "arhmexico";
...
<action id=""a5"" commandName=""Edit"" causesValidation=""true"" />
        ...
        public string LoadLayout(string view)
        {
            ...
            while (tryLoad)
            {
                ...
                {
                    var stream = GetType().Assembly.GetManifestResourceStream(string.Format("arhmexico.Views.{0}.{1}.html", this.ControllerName, view));
                    if (stream != null)
