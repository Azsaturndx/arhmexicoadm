...
namespace arhmexico.Data
{
	public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                	res = ControllerConfigurationUtility.GetResourceStream(string.Format("arhmexico.controllers.{0}.xml", controller), string.Format("arhmexico.{0}.xml", controller));
                if (res == null)
                {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            if (t == null)
            	t = typeof(arhmexico.Data.Controller);
            var res = ControllerConfigurationUtility.GetResourceStream(string.Format("arhmexico.Reports.{0}", name), string.Format("arhmexico.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                var config = arhmexico.Data.Controller.CreateConfigurationInstance(t, controller);
