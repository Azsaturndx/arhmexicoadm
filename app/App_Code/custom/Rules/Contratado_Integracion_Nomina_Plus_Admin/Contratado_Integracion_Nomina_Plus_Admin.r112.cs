...
namespace arhmexico.Rules
{
	public partial class Contratado_Integracion_Nomina_Plus_AdminBusinessRules : arhmexico.Rules.SharedBusinessRules
    {
        ...
        /// with a command name that matches "Custom" and argument that matches "ExecCS04".
        /// </summary>
        [Rule("r112")]
        public void r112Implementation(Contratado_Integracion_Nomina_Plus_AdminModel instance)
        {
