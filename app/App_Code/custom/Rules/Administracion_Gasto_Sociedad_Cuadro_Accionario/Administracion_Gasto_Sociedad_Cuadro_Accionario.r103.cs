...
{
	public partial class Administracion_Gasto_Sociedad_Cuadro_AccionarioBusinessRules : arhmexico.Rules.SharedBusinessRules
    {
        ...
        /// </summary>
        [Rule("r103")]
        public void r103Implementation(Administracion_Gasto_Sociedad_Cuadro_AccionarioModel instance)
        {
            ...
            if ((instance.Sociedad_Cuadro_Accionario_Id != null))
                sociedadCuadroAccionarioId = Convert.ToInt32(instance.Sociedad_Cuadro_Accionario_Id);

            if (sociedadCuadroAccionarioId == 0)
            {
                Result.ShowAlert("Es necesario seleccionar un cuadro accionario, el valor no puede ser nulo.");
            }//if (sociedadCuadroAccionarioId == 0)
            else
            {
                try
                {
                    using (SqlConnection con = new SqlConnection(conStr))
                    {
                        using (SqlCommand cmd = new SqlCommand("sp_Administrar_Gasto_Sociedad", con))
                        {
                            ...
                            //Rentas
                            cmd.Parameters.AddWithValue("@Mes_Gasto_Id", sociedadId);
            ...
            }//else if (sociedadCuadroAccionarioId == 0)
        }
    }
}
