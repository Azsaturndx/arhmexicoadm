...
namespace arhmexico.Rules
{
	public partial class Publicacion_VacanteBusinessRules : arhmexico.Rules.SharedBusinessRules
    {
        ...
        /// with a command name that matches "Custom" and argument that matches "EXECSQL01".
        /// </summary>
        [Rule("r104")]
        public void r104Implementation(Publicacion_VacanteModel instance)
        {
            // This is the placeholder for method implementation.
            
            // ESTA ES LA LLAMADA PARA CREACIÓN DE REGISTRO
            ...
            using (SqlConnection con = new SqlConnection(conStr))
            {
                using (SqlCommand cmd = new SqlCommand("sp_Genera_Publicacion_Vacante", con))
                {
                    ...
                    cmd.Parameters.AddWithValue("@Tipo_Operacion_Id", 1); // TIPO CREACIÓN
                    ...
                    cmd.Parameters.AddWithValue("@Publicacion_Vacante_Id", 0);
