...
namespace arhmexico.Rules
{
	public partial class Contratado_Solicitud_VacacionesBusinessRules : arhmexico.Rules.SharedBusinessRules
    {
        ...
        /// with a command name that matches "Custom" and argument that matches "EXECSQL03".
        /// </summary>
        [Rule("r105")]
        public void r105Implementation(Contratado_Solicitud_VacacionesModel instance)
        {
            ...
            using (SqlProcedure sql = new SqlProcedure("dbo.sp_Revision_De_Solicitud"))
            {
                ...
                sql.AddParameter("@Estado_Solicitud_Vacaciones", 2);// 4. Significa AUTORIZADO
